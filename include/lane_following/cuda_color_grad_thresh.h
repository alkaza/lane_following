#ifndef INCLUDE_LANE_FOLLOWING_CUDA_COLOR_GRAD_THRESH_H_
#define INCLUDE_LANE_FOLLOWING_CUDA_COLOR_GRAD_THRESH_H_
...
#endif /* INCLUDE_LANE_FOLLOWING_CUDA_COLOR_GRAD_THRESH_H_ */
